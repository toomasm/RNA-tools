...
def perform_alignment(reference_genome, reference_genome_index_base, fastq_filename, sam_output_filename):
    ...
    #There should be 6 genome index files. So 
    if len(index_list) != 7:
    ...
    cmd = "bowtie -v 1 -k 7 -p 2 -S --best --strata {0} {1} {2} ".format(reference_genome_index_base, fastq_filename, sam_output_filename)
